...
public class Main {
    ...
    /**
     * Determine the name of the output file, the class name derived from it and
     * the output folder.
     *
     * @param fileName base name of the file, possibly with folder/extension
     * etc.
    ...
    private static String getOutputFileName(String fileName) {
        ...
        if (lastPart >= 0) {
            fileName = fileName.substring(0, lastPart);
        }
