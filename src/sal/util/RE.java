...
public class RE {
     ...
     */
    public static String ch(char charVal) {
    ...
    */
    ...
    /** Form an alternation of elements
     *
     * @param stringList a list of strings
     *
     * @return strings separated by | in a non-capturing group.
     *
     * An empty list returns an empty string, otherwise the items are enclosed in a non-capturing group.
     */
    public static String alt(String... stringList) {

        int ln = stringList.length;
        if(ln == 0) return "";
        return stringList.length == 0 ? "" : "(?:"+ String.join("|", stringList) + ")";
    }
    ...
    public static String between(int low, int high, String... stringList) {
        StringBuilder sb = new StringBuilder(alt(stringList));
    ...
    public static String groupOf(String grp, String... stringList) {
        return new StringBuilder("(").append(grp).append(alt(stringList)).append(")").toString();
    }
